...
class LabyrintheGraphique(object):
    ...
    def afficheCarteAJouer(self):
        ...
        """
        self.surface.blit(self.surfaceCarte(getCarteAJouer(
            self.labyrinthe)), (self.finl+self.deltal//2, self.finh//2))
    ...
    def afficheJeu(self):
        ...
        self.afficheGrille()
        if not self.fini:
            self.afficheMessage(2, "C'est au joueur @img@ de jouer. Trésor à trouver @img@", [self.surfacePion(numJoueurCourant(
                getListeJoueurs(self.labyrinthe))), self.surfaceTresor(tresorCourant(getListeJoueurs(self.labyrinthe)))])
        self.afficheScore(3)
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN:
                ...
                if getPhase(self.labyrinthe) == 1:
                    ...
                    if x in ['N', 'E', 'S', 'O', 'T'] or x == -1 or y == -1:
                        ...
                        chemin = accessibleDistJoueurCourant(
                            self.labyrinthe, x, y)
...
if __name__ == '__main__':
    ...
    nbTresors = input(
        "Combien de trésors à trouver par joueur (0 pour le maximum possible)?")
    ok = True
    try:
