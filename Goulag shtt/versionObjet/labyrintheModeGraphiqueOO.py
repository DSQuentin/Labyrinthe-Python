...
class LabyrintheGraphique(object):
    ...
    def afficheJeu(self):
        ...
        self.afficheGrille()
        if not self.fini:
            self.afficheMessage(2,"C'est au joueur @img@ de jouer. Trésor à trouver @img@",[self.surfacePion(self.labyrinthe.getListeJoueurs().numJoueurCourant()),self.surfaceTresor(self.labyrinthe.getListeJoueurs().tresorCourant())])
        self.afficheScore(3)
            ...
            if ev.type==pygame.MOUSEBUTTONDOWN:
                ...
                if self.labyrinthe.getPhase()==1:
                    ...
                    if x in ['N','E','S','O','T'] or x==-1 or y==-1:
                        ...
                        chemin=self.labyrinthe.accessibleDistJoueurCourant(x,y)
